...
def create_static_graph_subject_lines(df, nombre_institucion, nombre_titulacion) -> BytesIO:
    # Agrupar por Año y Tasa, calculando la media del Valor
    df_agrupado = df.groupby(['Asignatura', 'Tasa'])['Valor'].mean().reset_index()
